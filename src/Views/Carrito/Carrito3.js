...
const addToCart = ()=> {dispatch({type: TYPES.ADD_TO_CART})};
const delFromCart = ()=> {};
const clearCart = ()=> {};
            ...
            <div class="col-md-8">
                <div class="product-details mr-2">
                    ...
                    <div class="d-flex justify-content-between"><span>
                        {items.map((item)=> <Item key={item.char_id} data ={item} addToCart={addToCart} />)}You have items in your cart</span>
                        <div class="d-flex flex-row align-items-center"><span class="text-black-50">Sort by:</span>
                            <div class="price ml-2"><span class="mr-1">price</span><i class="fa fa-angle-down"></i></div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                        <div class="d-flex flex-row"><img className="rounded" src="https://i.imgur.com/QRwjbm5.jpg" width="40"></img>
...
<label class="radio"> <input type="radio" name="card" value="payment"></input> <span><img width="30" src="https://img.icons8.com/officel/48/000000/visa.png"/></span> </label>

<label class="radio"> <input type="radio" name="card" value="payment"></input> <span><img width="30" src="https://img.icons8.com/ultraviolet/48/000000/amex.png"/></span> </label>
